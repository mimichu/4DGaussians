...
for wrist_delta_angle in [45]:
    ...
    # action: 
    #     shape: [10]
    # """.format(camera_name, camera_name1, camera_name2, camera_name3, camera_name4, camera_name5)
    shape_meta_yaml = """
    obs:
        {}_image:
            shape: [3, 1200, 1200]
    ...
    json_dict_train = {}
    json_dict_train['camera_angle_x'] = 120.0
    json_dict_frames = []
    stage = 'train'
    moving_animation_path = os.path.join(f'/local/real/chuerpan/repo/4DGaussians/data/robomimic/can/{stage}')
    if not os.path.exists(moving_animation_path):
        os.makedirs(moving_animation_path)
    counter_train = 0
    for t in tqdm.tqdm(train_idx):
    ...
    json_dict_val = {}
    json_dict_val['camera_angle_x'] = 120.0
    ...
    json_dict_test = {}
    json_dict_test['camera_angle_x'] = 120.0
