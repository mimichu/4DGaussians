...
from diffusion_policy.gaussians_utils.panorama_cam import create_data_stage_wise_static_panorama
...
for wrist_delta_angle in [45]:
    object = 'can'
    object_dir = f'{object}_panorama_move_fov_{FOV}_static_{TRAJ_LEN}_01'
    ...
    create_data_stage_wise_static_panorama(stage = 'train', 
    ...
    create_data_stage_wise_static_panorama(stage = 'val', 
                           save_path = local_save_path,
                           env = env,
                           fov = FOV, 
                           object_dir = object_dir,
    ...
    create_data_stage_wise_static_panorama(stage = 'test', 
                           save_path =local_save_path,
                           env = env,
                           fov = FOV, 
                           object_dir = object_dir,
